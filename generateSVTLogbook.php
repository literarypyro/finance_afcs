...
$shiftName=$shiftRow['shift_name'];
	...
	addContent(setRange("M".$rowCount,"M".$rowCount),$excel,$svt_packs_1,"true",$ExWs);
	addContent(setRange("N".$rowCount,"O".$rowCount),$excel,$svt_loose_1,"true",$ExWs);
...
for($m=0;$m<$nm;$m++){
	...
	if($nm>0){
		...
		addContent(setRange("G32","G32"),$excel,$turnover_sjt,"true",$ExWs);


		addContent(setRange("B33","D33"),$excel,$origin_ca,"true",$ExWs);
		addContent(setRange("F33","I33"),$excel,$destination_ca,"true",$ExWs);
		...
		addContent(setRange("B34","D34"),$excel,"Cash Assistant - Shift ".$logShift,"true",$ExWs);
		addContent(setRange("F34","I34"),$excel,"Cash Assistant - Shift ".$logShift,"true",$ExWs);
