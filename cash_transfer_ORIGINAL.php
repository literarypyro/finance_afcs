...
?>
<link rel="stylesheet" id='stylesheet' type="text/css" href="layout/control slip.css">
<?php
...
if((isset($_POST['cash_total']))&&($_POST['cash_total']>0)){
	...
	if($_POST['form_action']=="insert"){
		...
		$record_sql.=" values ";
		$record_sql.="('insert','cash transfer','".$record_date."','".$cash_transfer."','".$log_id."')";
...
//			$insert_id=$insert_id;
			...
			$record_sql="insert into history(action,element,transaction_time,reference_id,log_id) ";
			$record_sql.=" values ";
			$record_sql.="('update','cash transfer','".$record_date."','".$cash_transfer."','".$log_id."')";
			$record_rs=$record_db->query($record_sql);
