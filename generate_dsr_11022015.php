...
//				addContent(setRange("Q".$rowCount,"Q".$rowCount),$excel,($sv_discount),"true",$ExWs);
				...
				*/
				...
				addContent(setRange("Z".$rowCount,"Z".$rowCount),$excel,$svdDefective,"true",$ExWs);
				/*
...
//	addContent(setRange("J35","K35"),$excel,$svt_additional_amount,"true",$ExWs);
	...
	addContent(setRange("H37","I37"),$excel,"=D".$grandRowCount."+F".$grandRowCount,"true",$ExWs);
	addContent(setRange("J37","K37"),$excel,"=H".$grandRowCount,"true",$ExWs);
	
	addContent(setRange("H38","I38"),$excel,$sjt_loose,"true",$ExWs);
	addContent(setRange("J38","K38"),$excel,$svt_loose,"true",$ExWs);
	
	addContent(setRange("H39","I39"),$excel,"=Y".$grandRowCount,"true",$ExWs);
	addContent(setRange("J39","K39"),$excel,"=Z".$grandRowCount,"true",$ExWs);

	addContent(setRange("H40","I40"),$excel,"=W".$grandRowCount,"true",$ExWs);
	addContent(setRange("J40","K40"),$excel,"=X".$grandRowCount,"true",$ExWs);
	}
