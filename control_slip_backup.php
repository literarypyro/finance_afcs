...
?>
<td><span <?php if(isset($_POST['type_transact'])){ } else { echo "class='highlight'"; } ?> id='reference_header' name='reference_header'><b> Reference Id (Control Slip No.)</b> </span> <input type='text' name='reference_id' id='reference_id' value='<?php echo $row['reference_id']; ?>' /><input type=hidden name='reference_control' id='reference_control' value='<?php echo $control_id; ?>' /></td>
</tr>
</table>
...
if($nm>0){
	...
	$svd_amount=$sold_tickets["svd"]*10;
...
<tr>
<td>SJT</td>
<td><input type=text size=5 name='sjt_allocation_a' id='sjt_allocation_a' onkeyup="computeSequence('sjt','_allocation_a',event,'sjd_allocation_a')" value='<?php echo $allocation["sjt"]["initial"]; ?>' /></td>
<td><input type=text size=5 name='sjt_allocation_a_loose' id='sjt_allocation_a_loose' onkeyup="computeSequence('sjt','_allocation_a_loose',event,'sjd_allocation_a_loose')" value='<?php echo $allocation["sjt"]["initial_loose"]; ?>' /></td>

<td><input type=text size=5 name='sjt_allocation_b' id='sjt_allocation_b' onkeyup="computeSequence('sjt','_allocation_b',event,'sjd_allocation_b_loose')" value='<?php echo $allocation["sjt"]["additional"]; ?>' /></td>
<td><input type=text size=5 name='sjt_allocation_b_loose' id='sjt_allocation_b_loose' onkeyup="computeSequence('sjt','_allocation_b_loose',event,'sjd_allocation_b_loose')" value='<?php echo $allocation["sjt"]["additional_loose"]; ?>' /></td>
<td><input type=text size=5 name='sjt_unsold_a' id='sjt_unsold_a' onkeyup="computeSequence('sjt','_unsold_a',event,'sjd_unsold_a')"  value='<?php echo $unsold["sjt"]["sealed"]; ?>'  /></td>
<td><input type=text size=5 name='sjt_unsold_b' id='sjt_unsold_b' onkeyup="computeSequence('sjt','_unsold_b',event,'sjd_unsold_b')"  value='<?php echo $unsold["sjt"]["loose_good"]; ?>' /></td>

<td><input type=text size=5 name='sjt_unsold_c' id='sjt_unsold_c' onkeyup="computeSequence('sjt','_unsold_c',event,'sjd_unsold_c')"  value='<?php echo $unsold["sjt"]["loose_defective"]; ?>' /></td>
<td><input type=text name='sjt_total' id='sjt_total' value='<?php echo $sold_tickets["sjt"];?>' /></td>
<td><input type=text name='sjt_amount' id='sjt_amount' onkeyup='computeAmount(event,"sjd_amount")' value='<?php echo $sjt_amount; ?>' onblur='computeAmount(event,"sjd_amount");' /></td>
...
<tr>
<td>SJD</td>
<td><input type=text size=5 name='sjd_allocation_a' id='sjd_allocation_a' onkeyup="computeSequence('sjd','_allocation_a',event,'svt_allocation_a')"  value='<?php echo $allocation["sjd"]["initial"]; ?>' /></td>
<td><input type=text size=5 name='sjd_allocation_a_loose' id='sjd_allocation_a_loose' onkeyup="computeSequence('sjd','_allocation_a_loose',event,'svt_allocation_a_loose')"  value='<?php echo $allocation["sjd"]["initial_loose"]; ?>' /></td>

<td><input type=text size=5 name='sjd_allocation_b' id='sjd_allocation_b' onkeyup="computeSequence('sjd','_allocation_b',event,'svt_allocation_b')"  value='<?php echo $allocation["sjd"]["additional"]; ?>' /></td>
<td><input type=text size=5 name='sjd_allocation_b_loose' id='sjd_allocation_b_loose' onkeyup="computeSequence('sjd','_allocation_b_loose',event,'svt_allocation_b_loose')"  value='<?php echo $allocation["sjd"]["additional_loose"]; ?>' /></td>

<td><input type=text size=5 name='sjd_unsold_a' id='sjd_unsold_a'  onkeyup="computeSequence('sjd','_unsold_a',event,'svt_unsold_a')" value='<?php echo $unsold["sjd"]["sealed"]; ?>' /></td>
<td><input type=text size=5 name='sjd_unsold_b' id='sjd_unsold_b' onkeyup="computeSequence('sjd','_unsold_b',event,'svt_unsold_b')" value='<?php echo $unsold["sjd"]["loose_good"]; ?>' /></td>

<td><input type=text size=5 name='sjd_unsold_c' id='sjd_unsold_c' onkeyup="computeSequence('sjd','_unsold_c',event,'svt_unsold_c')" value='<?php echo $unsold["sjd"]["loose_defective"]; ?>' /></td>
<td><input type=text name='sjd_total' id='sjd_total' value='<?php echo $sold_tickets["sjd"];?>' /></td>
<td><input type=text name='sjd_amount' id='sjd_amount' onkeyup='computeAmount(event,"svt_amount")' value='<?php echo $sjd_amount; ?>'  onblur='computeAmount(event,"svt_amount");'  /></td>

</tr>

<tr>
<td>SVT</td>
<td><input type=text size=5 name='svt_allocation_a' id='svt_allocation_a' onkeyup="computeSequence('svt','_allocation_a',event,'svd_allocation_a')" value='<?php echo $allocation["svt"]["initial"]; ?>' /></td>
<td><input type=text size=5 name='svt_allocation_a_loose' id='svt_allocation_a_loose' onkeyup="computeSequence('svt','_allocation_a_loose',event,'svd_allocation_a_loose')" value='<?php echo $allocation["svt"]["initial_loose"]; ?>' /></td>

<td><input type=text size=5 name='svt_allocation_b' id='svt_allocation_b' onkeyup="computeSequence('svt','_allocation_b',event,'svd_allocation_b')" value='<?php echo $allocation["svt"]["additional"]; ?>' /></td>
<td><input type=text size=5 name='svt_allocation_b_loose' id='svt_allocation_b_loose' onkeyup="computeSequence('svt','_allocation_b_loose',event,'svd_allocation_a_loose')" value='<?php echo $allocation["svt"]["additional_loose"]; ?>' /></td>

<td><input type=text size=5 name='svt_unsold_a' id='svt_unsold_a' onkeyup="computeSequence('svt','_unsold_a',event,'svd_unsold_a')"  value='<?php echo $unsold["svt"]["sealed"]; ?>'   /></td>
<td><input type=text size=5 name='svt_unsold_b' id='svt_unsold_b' onkeyup="computeSequence('svt','_unsold_b',event,'svd_unsold_b')" value='<?php echo $unsold["svt"]["loose_good"]; ?>'   /></td>

<td><input type=text size=5 name='svt_unsold_c' id='svt_unsold_c' onkeyup="computeSequence('svt','_unsold_c',event,'svd_unsold_c')"  value='<?php echo $unsold["svt"]["loose_defective"]; ?>'  /></td>
<td><input type=text name='svt_total' id='svt_total' value='<?php echo $sold_tickets["svt"];?>' /></td>
<td><input type=text name='svt_amount' id='svt_amount' onkeyup='computeAmount(event,"svd_amount")'  value='<?php echo $svt_amount; ?>' onblur='computeAmount(event,"svd_amount");'  /></td>

</tr>
<tr>
<td>SVD</td>
<td><input type=text size=5 name='svd_allocation_a' id='svd_allocation_a' onkeyup="computeSequence('svd','_allocation_a',event,'sjt_allocation_a_loose')" value='<?php echo $allocation["svd"]["initial"]; ?>' /></td>
<td><input type=text size=5 name='svd_allocation_a_loose' id='svd_allocation_a_loose' onkeyup="computeSequence('svd','_allocation_a_loose',event,'svd_allocation_a_loose')" value='<?php echo $allocation["svd"]["initial_loose"]; ?>' /></td>

<td><input type=text size=5 name='svd_allocation_b' id='svd_allocation_b' onkeyup="computeSequence('svd','_allocation_b',event,'sjt_allocation_b')" value='<?php echo $allocation["svd"]["additional"]; ?>' /></td>
<td><input type=text size=5 name='svd_allocation_b_loose' id='svd_allocation_b_loose' onkeyup="computeSequence('svd','_allocation_b_loose',event,'svd_allocation_b_loose')" value='<?php echo $allocation["svd"]["additional_loose"]; ?>' /></td>

<td><input type=text size=5 name='svd_unsold_a' id='svd_unsold_a' onkeyup="computeSequence('svd','_unsold_a',event,'sjt_unsold_b')" value='<?php echo $unsold["svd"]["sealed"]; ?>'    /></td>
<td><input type=text size=5 name='svd_unsold_b' id='svd_unsold_b' onkeyup="computeSequence('svd','_unsold_b',event,'sjt_unsold_c')" value='<?php echo $unsold["svd"]["loose_good"]; ?>'   /></td>

<td><input type=text size=5 name='svd_unsold_c' id='svd_unsold_c' onkeyup="computeSequence('svd','_unsold_c',event,'svd_unsold_c')" value='<?php echo $unsold["svd"]["loose_defective"]; ?>'   /></td>
<td><input type=text name='svd_total' id='svd_total' value='<?php echo $sold_tickets["svd"];?>' /></td>
<td><input type=text name='svd_amount' id='svd_amount' onkeyup='computeAmount(event,"svd_amount")'  value='<?php echo $svd_amount; ?>' onblur='computeAmount(event,"svd_amount");'  /></td>
...
<tr class='grid'><th>Cash Advance</th><td><input type=text name='addition_1' id='addition_1' onkeyup='computeRemittance()' value='<?php echo $cash_advance; ?>' /></td></tr>
