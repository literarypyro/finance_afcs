...
//					if($compare>$end){
				...
				addContent(setRange("AC".$rowCount,"AC".$rowCount),$excel,$sjt_discrepancy,"true",$ExWs);
				addContent(setRange("AD".$rowCount,"AD".$rowCount),$excel,$sjd_discrepancy,"true",$ExWs);
				addContent(setRange("AE".$rowCount,"AE".$rowCount),$excel,$svd_discrepancy,"true",$ExWs);
				addContent(setRange("AF".$rowCount,"AF".$rowCount),$excel,$svt_discrepancy,"true",$ExWs);
