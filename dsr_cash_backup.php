...
$db=retrieveDb();
?>
<meta http-equiv="refresh" content="60;url=dsr_cash.php" />
<?php 
...
Part 1 | <a href='dsr_tickets.php<?php echo $clause; ?>'>Part 2</a> | <a href='dsr_summary_1.php<?php echo $clause; ?>'>Summary</a>
<?php 
if($extAvNM>0){ 
	if(isset($_GET['ext'])){ 
...
for($k=0;$k<$nm2;$k++){
	...
	$allocationSQL="select * from control_sold where control_id in (SELECT control_id FROM control_remittance where remit_log='".$log_id."' and station='".$stationStamp."' and remit_ticket_seller='".$row2['ticket_seller']."')";
	...
	$adjustmentSQL="select * from control_sales_amount where control_id in (SELECT control_id FROM control_remittance where remit_log='".$log_id."' and station='".$stationStamp."' and remit_ticket_seller='".$row2['ticket_seller']."')";
	...
	$fareSQL="select * from fare_adjustment where control_id in (SELECT control_id FROM control_remittance where remit_log='".$log_id."' and station='".$stationStamp."' and remit_ticket_seller='".$row2['ticket_seller']."')";
...
/*
	$otSQL="select * from control_cash where control_id in (SELECT control_id FROM control_remittance where remit_log='".$log_id."' and station='".$stationStamp."' and remit_ticket_seller='".$row2['ticket_seller']."')";
	$otRS=$db->query($otSQL);
	$otNM=$otRS->num_rows;
...
?>
	<tr>
		...
		<td align=right><font color=red><?php echo number_format($subtotal["sjtSold"]*1,0); ?></font></td>
	
		<td align=right><font color=red><?php echo	number_format($subtotal['sjtAmount']*1,2); ?></font></td> 
		
		<td align=right><font color=red><?php echo	number_format($subtotal['sjdSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['sjdAmount']*1,2); ?></font></td>
		
		<td align=right><font color=red><?php echo	number_format($subtotal['svdSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['svdAmount']*1,2); ?></font></td>
	
		<td align=right><font color=red><?php echo	number_format($subtotal['svtSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['svtAmount']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['fare_adjustment']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['ot_amount']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($subtotal['totalAmount']*1,2); ?></font></td>		
...
?>
	<tr>
		...
		<td align=right><font color=red><?php echo number_format($grandtotal["sjtSold"]*1,0); ?></font></td>
	
		<td align=right><font color=red><?php echo	number_format($grandtotal['sjtAmount']*1,2); ?></font></td> 
		
		<td align=right><font color=red><?php echo	number_format($grandtotal['sjdSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['sjdAmount']*1,2); ?></font></td>
		
		<td align=right><font color=red><?php echo	number_format($grandtotal['svdSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['svdAmount']*1,2); ?></font></td>
	
		<td align=right><font color=red><?php echo	number_format($grandtotal['svtSold']*1,0); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['svtAmount']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['fare_adjustment']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['ot_amount']*1,2); ?></font></td>
		<td align=right><font color=red><?php echo	number_format($grandtotal['totalAmount']*1,2); ?></font></td>		
